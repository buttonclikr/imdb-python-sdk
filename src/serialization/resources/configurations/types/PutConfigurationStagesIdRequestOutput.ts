...
export const PutConfigurationStagesIdRequestOutput: core.serialization.Schema<
    serializers.PutConfigurationStagesIdRequestOutput.Raw,
    ButtonclikrApi.PutConfigurationStagesIdRequestOutput
...
export declare namespace PutConfigurationStagesIdRequestOutput {
    type Raw =
        | "APPLE_PAYMENTSESSION_REQUEST_JSON"
        | "APPLE_REGISTER_MERCHANT_REQUEST_JSON"
        | "APPLE_UNREGISTER_MERCHANT_REQUEST_JSON"
