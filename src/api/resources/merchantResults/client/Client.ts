...
export declare namespace MerchantResults {
    interface Options {
...
/**
 * Result created after an oboarding attempt, it will contain important information related to the boarding and attempt.
 */
export class MerchantResults {
    constructor(protected readonly _options: MerchantResults.Options) {}

    /**
     * Query a Merchant Result or Query Merchant Results.
     *
     * @param {unknown} id - The ID of this resource, also known as the Merchant ID (MID).
     * @param {ButtonclikrApi.GetMerchantResultsIdRequest} request
     * @param {MerchantResults.RequestOptions} requestOptions - Request-specific configuration.
     *
    ...
    public async getMerchantResultsId(
        ...
        const _response = await core.fetcher({
            url: urlJoin(
                ...
                `merchantResults/${encodeURIComponent(id)}`
            ),
            method: "GET",
            headers: {
                search:
        ...
        if (_response.ok) {
            return serializers.GetMerchantResultsIdResponse.parseOrThrow(_response.body, {
     ...
     *
     * @param {ButtonclikrApi.GetMerchantResultsRequest} request
     * @param {MerchantResults.RequestOptions} requestOptions - Request-specific configuration.
     *
     * @throws {@link ButtonclikrApi.BadRequestError}
     *
     ...
     *     })
     */
    public async getMerchantResults(
        request: ButtonclikrApi.GetMerchantResultsRequest,
        requestOptions?: MerchantResults.RequestOptions
    ): Promise<ButtonclikrApi.GetMerchantResultsResponse> {
        ...
        if (_response.ok) {
            return serializers.GetMerchantResultsResponse.parseOrThrow(_response.body, {
                unrecognizedObjectKeys: "passthrough",
                allowUnrecognizedUnionMembers: true,
                allowUnrecognizedEnumValues: true,
                breadcrumbsPrefix: ["response"],
