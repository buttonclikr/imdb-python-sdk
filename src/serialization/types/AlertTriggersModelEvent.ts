...
export const AlertTriggersModelEvent: core.serialization.Schema<
    serializers.AlertTriggersModelEvent.Raw,
    ButtonclikrApi.AlertTriggersModelEvent
...
export declare namespace AlertTriggersModelEvent {
    type Raw =
        | "create"
        | "update"
        | "delete"
