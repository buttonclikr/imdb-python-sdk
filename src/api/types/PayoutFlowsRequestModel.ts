...
export interface PayoutFlowsRequestModel {
     ...
     *  </details>
     */
    trigger: ButtonclikrApi.PayoutFlowsRequestModelTrigger;
    /**
     ...
     * </details>
     */
    schedule: ButtonclikrApi.PayoutFlowsRequestModelSchedule;
    /** A multiplier that you can use to adjust the schedule set in the 'schedule' field, if it is set to a duration-based trigger, such as daily, weekly, monthly, or annually. This affects the Payout resource that is created by this payoutFlow. This field is specified as an integer and its value determines how the interval is multiplied. - `1` - **Subscription to trigger daily**. */
     ...
     */
    start?: number;
    /** The unit of measure for the Payout resource that is created, such as a Negative Percentage (replenish account by percent negative back to $0), For example, if the Entity has a negative balance of $10 and the amount is set to 10000 (100%), then $10 will be drawn from their account to fully replenish the balance to $0. */
    um: "percentneg";
    /**
    ...
    /** The identifier of the currency that this PayoutFlow is associated with, or the currency for this statement if it's not set. */
    currency?: ButtonclikrApi.PayoutFlowsRequestModelCurrency;
    /**
