...
export class Versions {
     ...
     * @param {ButtonclikrApi.GetVersionsIdRequest} request
    ...
    public async getVersionsId(
        ...
        if (_response.ok) {
            return serializers.GetVersionsIdResponse.parseOrThrow(_response.body, {
     ...
     * Details for query on versions coming soon
     *
     * @param {ButtonclikrApi.GetVersionsRequest} request
     * @param {Versions.RequestOptions} requestOptions - Request-specific configuration.
     *
     * @example
    ...
    public async getVersions(
        ...
        requestOptions?: Versions.RequestOptions
    ): Promise<ButtonclikrApi.GetVersionsResponse> {
        ...
        if (_response.ok) {
            return serializers.GetVersionsResponse.parseOrThrow(_response.body, {
                unrecognizedObjectKeys: "passthrough",
                allowUnrecognizedUnionMembers: true,
                allowUnrecognizedEnumValues: true,
                breadcrumbsPrefix: ["response"],
