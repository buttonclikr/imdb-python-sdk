...
export const TxnResultBankCodeProperty: core.serialization.Schema<
    serializers.TxnResultBankCodeProperty.Raw,
    ButtonclikrApi.TxnResultBankCodeProperty
...
export declare namespace TxnResultBankCodeProperty {
    type Raw =
        | "accepted_but_not_yet_processed"
        | "account_blocked"
        | "account_is_purged"
