...
export const PutTerminalsIdRequestType: core.serialization.Schema<
    serializers.PutTerminalsIdRequestType.Raw,
    ButtonclikrApi.PutTerminalsIdRequestType
...
export declare namespace PutTerminalsIdRequestType {
    type Raw =
        | "125158LLC"
        | "3Delta"
        | "3DeltaPws"
