...
export const PostConfigurationStagesRequestOutput: core.serialization.Schema<
    serializers.PostConfigurationStagesRequestOutput.Raw,
    ButtonclikrApi.PostConfigurationStagesRequestOutput
...
export declare namespace PostConfigurationStagesRequestOutput {
    type Raw =
        | "APPLE_PAYMENTSESSION_REQUEST_JSON"
        | "APPLE_REGISTER_MERCHANT_REQUEST_JSON"
        | "APPLE_UNREGISTER_MERCHANT_REQUEST_JSON"
