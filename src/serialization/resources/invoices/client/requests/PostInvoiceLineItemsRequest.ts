...
export const PostInvoiceLineItemsRequest: core.serialization.Schema<
    serializers.PostInvoiceLineItemsRequest.Raw,
    ButtonclikrApi.PostInvoiceLineItemsRequest
...
export declare namespace PostInvoiceLineItemsRequest {
    interface Raw {
        invoice?: unknown;
        invoiceItem?: unknown;
        quantity?: unknown;
